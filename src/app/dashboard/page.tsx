    ...
    <div className="bg-gray-50 w-screen h-svh p-4 md:p-12 lg:p-14  space-y-10 overflow-y-auto">
      <header className="bg-white p-6 rounded-xl flex flex-wrap md:flex-nowrap items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="font-medium text-lg text-gray-700">{user?.nome}</h2>
            <p className="text-gray-400">{user?.email}</p>
          </div>
        </div>

        <div className="flex space-x-6 items-center justify-end w-full mt-4 md:mt-0">
          <button onClick={handleUserLogout} className="text-sm">
            Sair da conta
          </button>
